...
Currently, by reading three bits, the amount of types has been limited
to eight permutations. This happened
...
Giving you eleven possible types. Note that any extension of the scheme
...
are only slightly self-descriptive and have to be communicated
...
sequences with length two (for key and value).

\subsubsection{Method}

The meaningful encoder tool, and a separately written tool, json2der were
used together to create an encoding for the format in question.
...
\begin{figure}[H]
\centering
\includegraphics[width=100mm]{comparison_chart}
\end{figure}
