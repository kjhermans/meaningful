...
\indent\hspace{.5cm} \textit{if} \textbf{type} = NULL: \newline
\indent\hspace{1cm} \textbf{push\_tuple(NULL)} \newline
\indent\hspace{.5cm} \textit{else if} \textbf{type} = EXPLICITNULL: \newline
\indent\hspace{1cm} \textbf{push\_tuple(NULL)} \newline
\indent\hspace{.5cm} \textit{else if} \textbf{type} = BOOLEAN: \newline
\indent\hspace{1cm} \textbf{push\_tuple(read\_boolean())} \newline
\indent\hspace{.5cm} \textit{else if} \textbf{type} = INTEGER: \newline
\indent\hspace{1cm} \textbf{push\_tuple(read\_integer())} \newline
\indent\hspace{.5cm} \textit{else if} \textbf{type} = FLOAT: \newline
\indent\hspace{1cm} \textbf{push\_tuple(read\_float())} \newline
\indent\hspace{.5cm} \textit{else if} \textbf{type} = STRING: \newline
\indent\hspace{1cm} \textbf{push\_tuple(read\_string())} \newline
\indent\hspace{.5cm} \textit{else if} \textbf{type} = ARRAY: \newline
\indent\hspace{1cm} \textbf{push\_tuple(read\_array())} \newline
\indent\hspace{.5cm} \textit{else if} \textbf{type} = HASHTABLE: \newline
\indent\hspace{1cm} \textbf{push\_tuple(read\_hashtable())} \newline
...
Continuity bits are also used in arrays and hashtables. A single bit (which
is always returned) determines whether or not the next element is read. Like so:
