...
\begin{itemize}
\item When using TLV \cite{bib:tlv}, they may contain types that aren't defined.
...
\item For example, in DER \cite{bib:ber} encoding it is possible to defines lengths
...
Currently, the amount of types has been limited by three bits to eight permutation.
This happened
